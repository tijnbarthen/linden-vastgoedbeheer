...
const testimonialItems = [
  {
    ...
    content:
      'Ik ben zo blij met de professionele service die ik heb ontvangen van het makelaarsteam. Ze hebben me geholpen om mijn droomhuis te vinden en het hele proces was eenvoudig en stressvrij. Ik zou ze ten zeerste aanbevelen aan iedereen die op zoek is naar een betrouwbare makelaar!',
  },
  {
    name: 'John Anderson',
    image: 'https://source.unsplash.com/random?person%20girl',
    content:
      'Als het gaat om het verkopen van mijn woning, was het team van deze makelaar echt fantastisch. Ze hebben mijn woning snel en tegen een geweldige prijs verkocht. Hun expertise en toewijding hebben echt het verschil gemaakt. Ik ben zeer tevreden met hun diensten!',
  },
  {
    name: 'Sophie Roberts',
    image: 'https://source.unsplash.com/random?person%20man',
    content:
      'Het vastgoedbeheerteam heeft uitstekend werk geleverd met het beheren van mijn investeringsportefeuille. Ze zorgen voor alles, van huurincasso tot onderhoudsverzoeken. Ik hoef me geen zorgen te maken en kan gewoon genieten van mijn rendement. Ze zijn absoluut betrouwbaar en efficiënt!',
  },
];
...
export default function Testimonials() {
  const testimonialItemsCopy = [...testimonialItems];
  useEffect(() => {
            ...
            <div className="relative px-6 pb-8 md:px-12 lg:pb-0">
              ...
              <div className="testimonial-carousel swiper-container">
                <div className="swiper-wrapper">
                  {testimonialItemsCopy.map((item, index) => (
  ...
  return (
    <div className="swiper-slide space-y-8 lg:flex items-center lg:space-y-0 lg:space-x-8 text-center lg:text-left">
      ...
      <div className="relative">
        ...
        <h4 className="h3 font-cabinet-grotesk mb-4">{item.content}</h4>
      </div>
    </div>
  );
};
